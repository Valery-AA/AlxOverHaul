...
def GetObjectModifiersOfType(target_object: bpy.types.Object = None, target_type: str = ""):
    if (target_object is not None) and (target_type in GetDefaultModifierTypes()):
